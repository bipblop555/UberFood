...
public class Seeder
{
    public void SeedData()
    {
        ...
        context.Doughs.Add(dough1); 

        var dough2 = new Dough { Name = "Fine" };
        context.Doughs.Add(dough2); 

        var dough3 = new Dough { Name = "Épaisse" };
        context.Doughs.Add(dough3); 
        ...
        var ingredients = new List<Ingredient>
    {
        ...
        new Ingredient { Name = "Fromage de chèvre", Pizza = pizza3, KCal = 300 }
    };
